...
const placeholderModules: Module[] = [
  {
    ...
    lessons: [
      { type: 'video', title: 'What is Data Science?', duration: '15 min' },
      { type: 'text', title: 'Data Science Applications', duration: '10 min' },
      { type: 'quiz', title: 'Knowledge Check', duration: '5 min' },
    ],
  },
  {
    ...
    lessons: [
      { type: 'video', title: 'Data Sources', duration: '20 min' },
      { type: 'text', title: 'Data Cleaning Techniques', duration: '25 min' },
      { type: 'quiz', title: 'Data Validation Quiz', duration: '10 min' },
    ],
  },
];
...
export function ContentTab({ modules = placeholderModules }: ContentTabProps) {
  return (
    ...
    <Card>
      ...
      <CardContent className="space-y-2 pl-12">
        {module.lessons.map((lesson, lessonIndex) => (
          <LessonItem key={lessonIndex} lesson={lesson} index={lessonIndex} />
        ))}
      </CardContent>
    </Card>
  );
